...
For Lab 1, you should submit your solutions to Canvas as a `.pdf` and include an *R Script* or your code in an appendix or .txt file.

Please see the *Preparing Lab Reports* section at the bottom of this assignment.

Your file name should read: FirstName_LastName_Lab#
...
You will submit your final output on Canvas [here](https://canvas.howard.edu/courses/46792).
...
Homework in our course contains **Exercises**.

Labs contain **Reports**.

In this way, we have *homework exercises* and *lab reports*.
...
In the future, you will submit your reports using what is called a *Quarto Markdown* file `(.qmd)`.

For Lab 1, you may submit your lab reports to Canvas in any format that you prefer. That is, you can submit our lab reports as a `.pdf` or an *R Script* or even as a `.txt` file; that said, I prefer that you <u>not</u> submit `.doc` or `.docx` files.
