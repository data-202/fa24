...
|                                    | Lab #0                  | Due: Tue Aug 27    |
|                                    | Annotated Bibliography  | Due: Sun Sept 8    |
|                                    | Lab #1                  | Due: Sun Sept 22   |
| **Part II: Data and people**       |                         |                    |
|                                    | Paper #1                | Due: Fri Sept 25   |
|                                    | ~~Midterm examination~~ | ~~Due: Sun Oct 6~~ |
| **Part III: Data and policy**      |                         |                    |
|                                    | Lab #2                  | Due: Sun Oct 27    |
|                                    | Paper #2                | Due: Sun Nov 10    |
| **Part IV: Data in practice**      |                         |                    |
|                                    | Lab #3                  | Due: Sun Nov 17    |
|                                    | Paper #3                | Due: Sun Dec 1     |
|                                    | Paper #4 (optional)     | Due: Mon Dec 9     |

### **Sample exercises**

Below are a few sample exercises. This work is ungraded, and while there is no prerequisite for this course, these problems should serve as a review and a preview of content that we'll explore for the course. Please do not hesitate to reach out with questions.
